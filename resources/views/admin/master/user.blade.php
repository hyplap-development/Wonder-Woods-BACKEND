            ...
            <table class="table table-bordered table-hover table-responsive-lg" id="tabdata" style="margin-top: 13px !important">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($data->phone == '8433885667')
                            <div class="align-middle text-center">
                                <p>Update Not Allowed</p>
                            </div>
                            @else
                            <div class="align-middle text-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" onkeyup="checkEmailUpdate('{{$data->id}}')" id="Email{{$data->id}}" name="email" autocomplete="false" value="{{$data->email}}" required>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" onkeyup="checkPhoneUpdate('{{$data->id}}')" id="Phone{{$data->id}}" name="phone" maxlength="10" pattern="[6789][0-9]{9}" value="{{$data->phone}}" required>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" name="role" required id="Role{{$data->id}}">
