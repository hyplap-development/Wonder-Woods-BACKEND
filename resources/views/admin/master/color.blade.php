...
<div class="modal fade" id="addModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content ">
            ...
            <form autocomplete="off" action="{{url('admin/color/add')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label style="font-weight: bold;">Color <span style="color: red;">&#42</span></label>
            ...
            <table class="table table-bordered table-hover table-responsive-lg" id="tabdata" style="margin-top: 13px !important">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle text-center" style="max-width: 50px;">Color</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center">
                            <div style="width: 50px; height: 50px; border-radius: 5px; background-color: {{$color}};"></div>
                        </td>
                        <td class="align-middle text-center">
                            @if($data->status == 1)
                    ...
                    <div class="modal fade" id="updateModal{{$data->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <form action="{{url('admin/color/update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label style="font-weight: bold;">Color <span style="color: red;">&#42</span></label>
                                                    <input type="color" class="form-control" id="color" name="color" value="{{$data->code}}" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                    ...
                    <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <form action="{{url('/admin/color/delete')}}" method="post">
                                    @csrf
                                    <input type="hidden" value="{{$data->id}}" name="hiddenId">
                                    <div class="modal-body">
