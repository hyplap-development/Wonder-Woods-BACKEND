...
<div class="modal fade" id="addModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <form autocomplete="off" action="{{url('admin/gst/add')}}" enctype="multipart/form-data" method="post">
            @csrf
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Gst</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <lord-icon src="https://cdn.lordicon.com/vfzqittk.json" trigger="hover" state="hover-2" gsts="primary:#000000" style="width:35px;height:35px">
                        </lord-icon>
                    </button>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label style="font-weight: bold;">Percent <span style="color: red;">&#42</span></label>
                                <input type="number" min="0" max="100" class="form-control" id="percent" name="percent" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
    ...
    <div class="card card-custom ">
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover table-responsive-lg" id="tabdata" style="margin-top: 13px !important">
                ...
                <tbody>
                    @foreach($gsts as $data)
                    <tr>
                        <td class="align-middle text-center">{{ $loop->iteration }}</td>
                        <td class="align-middle text-center">{{$data->percent}} %</td>
                    ...
                    <div class="modal fade" id="updateModal{{$data->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <form action="{{url('admin/gst/update')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label style="font-weight: bold;">Percent <span style="color: red;">&#42</span></label>
                                                    <input type="number" min="0" max="100" class="form-control" id="percent" name="percent" value="{{$data->percent}}" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                    ...
                    <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <form action="{{url('/admin/gst/delete')}}" method="post">
                                    @csrf
                                    <input type="hidden" value="{{$data->id}}" name="hiddenId">
                                    <div class="modal-body">
