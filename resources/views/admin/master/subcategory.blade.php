    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('admin/subcategory/importExcel')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status == 200) {
                    nameTitle.innerHTML = "Sub Category is already added";
            ...
            success: function(response) {
                if (response.status == 200) {
                    if (response.data.name == nameHidden.value) {
                        nameTitle.innerHTML = "Current subcategory name";
                        nameTitle.style.color = 'green';
                        name.style.border = '1px solid green';
