...
<head>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('media/logo.png')}}">
...
<body id="kt_body" class="print-content-only header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="{{url('admin/dashboard')}}">
            <img alt="Logo" src="{{asset('media/logo.png')}}" style="height: 70px;" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="{{url('admin/dashboard')}}" class="brand-logo">
                        <img alt="Logo" src="{{asset('media/logo.png')}}" onerror="this.onerror=null;this.src='/media/logo.png'" style="height: 70px;" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                        <ul class="menu-nav">
                            <li class="menu-item {{ Request::is('admin/dashboard*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{url('admin/dashboard')}}" id="dashboard" class="menu-link">
                            ...
                            <li class="menu-item menu-item-submenu {{ Request::is('admin/enduser*','admin/enquiries*') ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item {{ Request::is('admin/enduser*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                            <a href="{{url('admin/enduser')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
